...
export const selecteNumberOfItems=(state)=>state.cart.items.length;
...
export const selectDeliveryPrice=createSelector(
    cartSelector,selectSubtotal,(cart,subtotal)=>(subtotal > cart.freeDeliveryFrom ? 0:cart.deliveryFee)
